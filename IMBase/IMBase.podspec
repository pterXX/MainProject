...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/pterXX/IMBase"
  ...
  s.source       = { :git => "https://github.com/pterXX/IMBase", :tag => s.version.to_s }
  ...
  s.source_files  = "IMBase/IMBase/**/*.{h,m,swift}"
