...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/pterXX/IMLogin"
  ...
  s.source       = { :git => "https://github.com/pterXX/IMLogin.git", :tag => s.version.to_s }
  ...
  s.source_files  = "IMLogin/IMLogin/**/*.{h,m,swift}"
